...
namespace Practice\Ccq\Console\Command;
...
class HelloWorld extends Command
{
     ...
     * @const
     */
    private const TOPIC = 'practice_hello_world';
    ...
    {
        $this->setName('practice:hello:world');
        $this->setDescription('Practice Training Unit2 Command');
        $this->setDefinition([
            new InputOption(
    ...
    protected function execute(
        ...
        try {
            if (($var1 = $input->getOption(self::INPUT_OPTION_VAR1)) && ($var2 = $input->getOption(self::INPUT_OPTION_VAR2))) {
                $output->writeln("<info>added to practice_hello_world job to a queue, passing it these $var1 && $var2 two parameters.</info>");
